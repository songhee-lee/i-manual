...
class ActionLeadingCentersIntro(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if h_center == 0 and metadata['ct'][0]==1:
            ...
            msg = "당신은 항상 몸에 활력 에너지가 존재하고, 다른 사람들의 지속적인 에너지 사용에 영향을 주는 사람입니다."
            msg2 = "자신이 좋아하는 일을 위해서는 며칠 밤을 새우더라도 괜찮을 수 있는 에너지를 지니고 있습니다. 하지만 이 에너지는 당신이 정말 좋아하는 일을 위해서 사용할 때만 활성화될 수 있습니다. 그렇지 않다면 당신은 만성피로에 시달리는 활력 없는 사람이 되고 말 것입니다."
            msg3 = "에너지를 활성화 시킬 수 있는지 알기 위해서는 주변 사람들에게 'Yes' or 'No'로 답이 가능한 형태의 질문을 받아야 합니다. 당신이 바로 ‘Yes’라고 답하는 일이라면 당신은 늘 활기찰 수 있습니다."
            ...
            msg = "당신은 생각하고 의견을 내는 데에 있어서 자신만의 일정한 방식을 갖고 있고, 자기 신념이 확고한 편입니다."
            msg2 = "도표나 그림을 떠올리며 생각을 하기도 하고, 어떤 소리가 들려와 생각하기도 하고, 과거에 했던 경험을 바탕으로 생각을 하는 등의 과정을 거쳐 자기만의 의견을 가지게 됩니다."
            msg3 = "이렇게 형성된 당신의 의견은 좀처럼 바뀌지 않고, 외부의 영향에도 잘 흔들리지 않습니다. 하지만, 무언가를 이해하려고 집착적으로 생각하다가 근심에 휩싸일 수 있으니 생각은 생각일 뿐, 행동으로 옮기는 것에는 신중하기 바랍니다. "
        elif h_center == 8 and metadata["ct"][8] == 1:
            h_type = "영감 센터 ( 정의 )"
            img = "https://asset.i-manual.co.kr/static/images/centerCard/card_8.gif"
            msg = "당신은 다른 사람들이 무언가에 대해 생각하도록 영감을 주는 사람입니다. 항상 머릿속에 떠오르는 의문에 대한 답을 찾는 사람이기도 합니다. "
            msg2 = "때때로 과거의 경험이 떠올라 혼란스러울 수 있고, 무언가에 대한 의심이 들고, 알듯 말듯한 것을 명확히 알고 싶어지지만 이것은 단지 당신이 세상을 이해하기 위한 현상일 뿐입니다."
            msg3 = "억지로 답을 찾으려는 노력을 하는 동안에는 답이 보이지 않고, 답을 찾기를 멈추었을 때, 답을 보게 될 것입니다."
            ...
            msg = "당신은 인류의 34%에 속하는 비교적 활력 에너지가 부족한 부류의 사람입니다. 더 일하고 싶고, 더 공부하고, 더 놀고, 더 자고, 더 먹고 등등 당신은 늘 아쉽습니다. 더 해야할 것 같고, 더 했으면 좋겠는데 생각과 달리 체력이 따라주지 않습니다."
            msg2 = "그럼에도 늘 '더 하고 싶어!! 더 할거야!!' 라고 생각하며 늘 지나치게 무언가를 합니다. 자신에게 활력 에너지가 부족함에도 마치 가지고 있는 것처럼 착각하기 쉽습니다."
            ...
            msg = "당신은 다른 사람이나 다른 무언가로부터 오는 다양한 사고방식에 열려 있고 스폰지처럼 정보를 흡수할 수 있는 사람입니다. '이런 의견도 있구나. 저렇게 생각할 수도 있겠는데? 이 정보도 일리가 있어' 라고 생각합니다."
        ...
        if h_center == 1 or h_center == 7 or h_center == 8:
            dispatcher.utter_message(f'당신의 {h_type}에 대해 이해가 되었나요?')
