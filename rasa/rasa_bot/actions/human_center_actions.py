...
class ActionLeadingCentersIntro(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if h_center == 0 and metadata['ct'][0] == 1:
            ...
            img = "~/masterbot/rasa/rasa_bot/data/center_image/center0_defined.png"
            img = "./data/center_image/center0_defined.png"
            ...
            img = "~/masterbot/rasa/rasa_bot/data/center_image/center1_defined.png"
            img = "./data/center_image/center1_defined.png"
            # img = "https://drive.google.com/file/d/1dquf_0m438T_paU7Ol7iOiggYsVNFlQ7/view?usp=sharing"
            ...
            img = "~/masterbot/rasa/rasa_bot/data/center_image/center2_defined.png"
            img = "./data/center_image/center2_defined.png"
            # img = "https://drive.google.com/file/d/1oNh_VRke43Cd-YOiqkQ7er5arJ7OQ_r2/view?usp=sharing"
            ...
            img = "~/masterbot/rasa/rasa_bot/data/center_image/center3_defined.png"
            img = "./data/center_image/center3_defined.png"
            # img = "https://drive.google.com/file/d/1MKCs1q4x5bvGYLJrA3R3eg847Q0XhW_Z/view?usp=sharing"
            ...
            img = "~/masterbot/rasa/rasa_bot/data/center_image/center4_defined.png"
            img = "./data/center_image/center4_defined.png"
            # img = "https://drive.google.com/file/d/1WW8Imsn7wpNXK74YrsbGPYR1S2YGHYGs/view?usp=sharing"
            ...
            img = "~/masterbot/rasa/rasa_bot/data/center_image/center5_defined.png"
            img = "./data/center_image/center5_defined.png"
            # img = "https://drive.google.com/file/d/12vigDVX-8PK4QZqWccq4ccm0sKkvfcxL/view?usp=sharing"
            ...
            img = "~/masterbot/rasa/rasa_bot/data/center_image/center6_defined.png"
            img = "./data/center_image/center6_defined.png"
            # img = "https://drive.google.com/file/d/1uS0oU2KxEm-MhMM70VkVQGDNMJz-Z0Dj/view?usp=sharing"
            ...
            img = "~/masterbot/rasa/rasa_bot/data/center_image/center7_defined.png"
            img = "./data/center_image/center7_defined.png"
            # img = "https://drive.google.com/file/d/1io5DwXD_aNZFlE8rpLBGJ5zxfPxCYymt/view?usp=sharing"
            ...
            img = "~/masterbot/rasa/rasa_bot/data/center_image/center8_defined.png"
            img = "./data/center_image/center8_defined.png"
            # img = "https://drive.google.com/file/d/1cSTTFCrktCQAWDRm66jZwLlQgNG3LljR/view?usp=sharing"
            ...
            img = "~/masterbot/rasa/rasa_bot/data/center_image/center0_undefined.png"
            img = "./data/center_image/center0_undefined.png"
            # img = "https://drive.google.com/file/d/1G5vI5uFs-yAsWB2Qy_ovf8gCsVJoYajc/view?usp=sharing"
            ...
            img = "~/masterbot/rasa/rasa_bot/data/center_image/center1_undefined.png"
            img = "./data/center_image/center1_undefined.png"
            # img = "https://drive.google.com/file/d/1T0kZas_COCBy2dnH3TMu11DWvRALGW8G/view?usp=sharing"
            ...
            img = "~/masterbot/rasa/rasa_bot/data/center_image/center2_undefined.png"
            img = "./data/center_image/center2_undefined.png"
            # img = "https://drive.google.com/file/d/1H1N_9uz23gvRoxcbUJfnCQosywqP2LB4/view?usp=sharing"
            ...
            img = "~/masterbot/rasa/rasa_bot/data/center_image/center3_undefined.png"
            img = "./data/center_image/center3_undefined.png"
            # img = "https://drive.google.com/file/d/1dy4E12ExPVpHSDx1A3w7iPecsPvyfQ4I/view?usp=sharing"
            msg = "인류의 절반은 자신만의 감정 에너지를 갖고 발신하며 살고 있고, 나머지 절반은 특별한 감정 에너지 없이 다른 절반이 발신하는 감정 에너지에 영향을 받으며 살아가고 있습니다. "
            msg2 = "이러한 감정 에너지와 관련된 센터를 감정센터라고 부릅니다. 감정센터가 정의되어 있는 사람들은 자신만의 감정 에너지의 사이클을 갖도록 디자인된 사람들입니다. "
            ...
            img = "~/masterbot/rasa/rasa_bot/data/center_image/center4_undefined.png"
            img = "./data/center_image/center4_undefined.png"
            # img = "https://drive.google.com/file/d/1OImRCymShNS3rsgcI7rcI6cZRgNkPJ9Z/view?usp=sharing"
            ...
            #img = "~/masterbot/rasa/rasa_bot/data/center_image/center5_undefined.png"
            img = "./data/center_image/center5_undefined.png"
            # img = "https://drive.google.com/file/d/1m1affqpH0-HyspYqSXx-UJ7qyA59mmie/view?usp=sharing"
            ...
            #img = "~/masterbot/rasa/rasa_bot/data/center_image/center6_undefined.png"
            img = "./data/center_image/center6_undefined.png"
            # img = "https://drive.google.com/file/d/12zA1etS-6EXaD4vgYXTLWUryS8XxSazW/view?usp=sharing"
            ...
            #img = "~/masterbot/rasa/rasa_bot/data/center_image/center7_undefined.png"
            img = "./data/center_image/center7_undefined.png"
            # img = "https://drive.google.com/file/d/1LcXu6hrMwpOmJw8TRNZiRfbXktZFEC1l/view?usp=sharing"
            ...
            #img = "~/masterbot/rasa/rasa_bot/data/center_image/center8_undefined.png"
            img = "./data/center_image/center8_undefined.png"
            # img = "https://drive.google.com/file/d/12mvbig-zepljG4Z65Dv9lf-HgYu6-qbp/view?usp=sharing"
...
class ActionLeadingCenters(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if h_center == 0 and metadata['ct'][0] == 1:
            ...
            center_name = "에고센터"
            img = "https://asset.i-manual.co.kr/static/images/centerCard/card_4_off.png"
            msg = "하지만, 에고센터가 정의되어 있는 사람들과 섞여 살수 밖에 없으므로 그들이 발신하는 에너지를 수신하고 심지어 증폭함으로써 굳이 지킬 수 없는 약속을 하거나 자신을 채찍질하고 밀어붙이는 삶을 살게 되기 쉽습니다. "
