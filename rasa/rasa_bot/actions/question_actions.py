...
class ActionDefaultFallback(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        yes_list= ["네", "네 맞아요", "네맞아요", "맞아요", "그런 것 같아요", "맞아", "응", "응맞아", "응 맞아", "그치", "그래요", "그래", "네 그런편이에요", "그런편이에요", "예", "네네", "웅", "응응", "그렇죠", "맞는거같아요", "그런듯", "완전 맞아요", "넹", "완전 그래요", "ㅇㅇ", "ㅇ", "yes", "yeah", "y"]
        no_list = ["아니요", "아뇨", "아니에요", "아녜요", "아닙니다", "아니", "안그래", "전혀 아니야", "전혀아님", "아님", "아니 그렇진 않아", "전혀", "아니!", "아니요.", "아니.", "ㄴㄴ", "ㄴ", "no", "nono", "n", "절대 아니야", "아니 전혀", "놉", "노", "노노", "안그래", "안히", "안니", "않니", "그럴리가", "그럴리가요"]
        # 설명 완료한 개수-> step
