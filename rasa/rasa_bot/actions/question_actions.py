...
class ActionDefaultFallback(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        yes_list= ["네", "네 맞아요", "네맞아요", "맞아요", "그런 것 같아요", "그런것같아요", "그런것 같아요", "그런거같아요", "그런거 같아요", "그런거같아", "그런 거 같아", "맞아", "응", "응맞아", "응 맞아", "그치", "그래요", "그래", "네 그런편이에요", "그런편이에요", "예", "네네", "웅", "응응", "그렇죠", "맞는거같아요", "그런듯", "완전 맞아요", "넹", "완전 그래요", "ㅇㅇ", "ㅇ", "yes", "yeah", "y"]
