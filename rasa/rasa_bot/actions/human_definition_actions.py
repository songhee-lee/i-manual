...
class ActionLeadingDefinitionIntro(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if is_finished == True:
            ...
            if leading_priority[0] == 2:  # 에너지 흐름이 첫번째 설명이라면
                if (metadata["t"] == 0):
                    dispatcher.utter_message(
                        f'절전모드 인트로')
                elif (metadata["t"] == 1):
                    ...
                    dispatcher.utter_message(
                        f'당신은 인류의 11%에 해당하는 특별한 사람입니다.')
                elif (metadata["t"] == 4):
                    dispatcher.utter_message(
                        f'당신은 인류의 1%에 해당하는 아주 특별한 사람입니다.')
            else:
                dispatcher.utter_message(
                    f'다음으로 에너지 흐름을 살펴보겠습니다.')
        msg = ""
        msg2 = ""
        msg3 = ""
        msg4 = ""
        ...
        if metadata["d"] == 0:
            ...
            msg2 = "정의된 여러 개의 센터가 한 묶음으로 연결 되어있어 다른 사람을 통한 센터 연결이 필요 없습니다. 따라서, 당신은 혼자서도 자기만의 공간에서 일이나 공부에 잘 집중할 수 있고, 다른 에너지 흐름을 가진 사람들보다 이해나 행동이 빠르고 수월합니다."
            msg3 = "당신은 혼자서도 집중하는데 어려움이 없음으로 혼자서 작업을 하거나 혼자 있는 시간과 공간에 대해서 불편함을 느끼지 않습니다. 하지만, 세상은 홀로 살아갈 수 없기에 사람들과 어떻게 관계하면 좋을지에 대해서는 다른 사람들로부터 지혜를 배우려고 노력하면 좋습니다."
            tag = "혼자서도 잘해요,조용하면 집중력 UP,홀로 공부할 것"
        elif metadata["d"] == 2:
            h_type = "두 묶음 흐름"
            img = "https://asset.i-manual.co.kr/static/images/profile/definition/definition_2.png"
            msg = "당신의 에너지는 두 부분으로 나뉘어 흐르고 있습니다."
            msg2 = "따라서 당신은 혼자 자기만의 공간에서 일이나 공부를 하기보다는 다양한 사람들의 에너지가 있는 카페나 도서관, 사무실 등에서 더욱 집중이 잘되고 효율적일 수 있습니다."
            msg3 = "당신은 다른 사람들에 대한 관심이 많기 때문에 인간관계가 무엇인가, 인간관계는 어떻게 하는 것인가에 대한 지혜를 갖고 있습니다."
            msg4 = "아주 친한 친구나 가족이나 배우자만을 의지한다면 한계가 있는 일정한 영향력을 받을 수 있으므로 혼자 할 수 있는 공공장소를 많이 활용할 것을 추천합니다."
            ...
            msg2 = "에너지가 세 묶음으로 나뉘어진 당신은 여러 명의 사람들과 함께 있을수록 좋습니다. 그 중 한명이라도 당신의 에너지 흐름을 연결해주어 만족감을 줄 수 있기 때문입니다. 하지만, 어느 특정한 사람과 지속적으로 깊은 관계를 이어갈 경우에는 뭔가 메여 있는 느낌을 받을 수도 있습니다."
            tag = "갈대같은 사람,한 곳에서 집중이 힘듦,자리를 바꿔 공부할 것"
        elif metadata["d"] == 4:
            h_type = "네 묶음 흐름"
            img = "https://asset.i-manual.co.kr/static/images/profile/definition/definition_4.png"
            msg = "모든 사람들은 한 묶음부터 네 묶음까지 자신만의 에너지 흐름을 갖고 있습니다. 당신을 구성하고 있는 디자인 차트의 9개 센터들이 몇 개의 묶음으로 이루어졌는지를 말하는 것입니다. 당신은 인류의 1%에 해당하는 네 묶음 에너지 흐름을 갖고 태어났습니다. 네 묶음 에너지 흐름을 가진 당신은 얼핏 보기에는 느리고 더딘 것처럼 보일 수 있습니다."
            msg2 = "네묶음 흐름에게 빨리 답을 결정하라고 재촉할 경우 그들은 스스로에게 파괴적인 성향을 가지게 되고, 삶의 모든 단계별로 자기자신을 부정하고 혐오하게 될 수 있습니다. 각각 따로 놀고 있는 에너지를 정돈하고 뜻을 모을 충분한 시간을 필요로 합니다. 약간의 시간과 여유만 제공된다면 자신이 가진 모든 센터들의 힘을 모아 독특한 색채를 발현할 수 있습니다."
            tag = "우유부단,새로운게 필요해,친구들과 공부할 것"

        dispatcher.utter_message(
            f'{metadata["pn"]}님, 당신의 에너지 흐름은 {h_type} 이시네요!', image=img)
        if msg != "":
...
class ActionLeadingDefinitionMore(Action):
    def name(self) -> Text:
        return "action_leading_definition_more"
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        buttons = []
        buttons.append({"title": f'아니오, 설명해주세요', "payload": "/definition_common_mean"})
        buttons.append({"title": f'알고 있어요, 다음 설명 듣고 싶어요!', "payload": "/leading_authority"})
        buttons.append({"title": f'이 항목 말고 다른 설명을 듣고 싶어요', "payload": "/leading_more"})

        dispatcher.utter_message(
             f'추가로 에너지흐름에는 5가지 타입이 있는 것을 알고 계신가요?', buttons=buttons)

        return [SlotSet('step', 2)]        

class ActionGetHumanDesignDefinition(Action):
    def name(self) -> Text:
        return "action_get_humandesign_definition"
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if h_definition == 'definition-0':
            ...
            msg5 = "이 에너지 흐름을 가진 사람들은 인류의 1% 분포에 해당됩니다."
            tag = "카멜레온,무한한 잠재성,틈틈이 휴식할 것"
        elif h_definition == 'definition-1':
            h_type = "한 묶음 흐름"
            img = "https://asset.i-manual.co.kr/static/images/profile/definition/definition_1.png"
            msg = "당신이 가지고 있는 에너지흐름은 다른 누구의 도움이 없이 혼자서도 잘 조화를 이루어 흐릅니다."
            msg2 = "그래서 당신은 혼자서도 자기만의 공간에서 일이나 공부에 잘 집중하여 효율적으로 해나갈 수 있고, 다른 에너지흐름을 가진 사람들보다 이해나 행동하는 데에 있어 수월합니다."
            ...
            msg5 = "이 에너지 흐름을 가진 사람들은 인류의 41% 분포에 해당됩니다."
            tag = "혼자서도 잘해요,조용하면 집중력 UP,홀로 공부할 것"
        elif h_definition == 'definition-2':
            h_type = "두 묶음 흐름"
            img = "https://asset.i-manual.co.kr/static/images/profile/definition/definition_2.png"
            msg = "혼자있을 때, 집중하여 일이나 공부가 잘 되지 않는 당신은 자신 이외의 다른 것에 대한 필요를 느끼고 있습니다."
            msg2 = "당신의 에너지들은 두 부분으로 나뉘어 흐르고 있기 때문에 혼자 자기만의 공간에서 일이나 공부를 하기보다는 다양한 사람들의 에너지가 있는 카페나 도서관, 사무실 등에서 더욱 집중이 잘되고 효율적이 됩니다."
            ...
            msg5 = "이 에너지 흐름을 가진 사람들은 인류의 46% 분포에 해당됩니다."
            tag = "카페에서도 공부 잘함,사람에 관심이 많아요,사람 많으면 아이디어 UP"
        elif h_definition == 'definition-3':
            h_type = "세 묶음 흐름"
            img = "https://asset.i-manual.co.kr/static/images/profile/definition/definition_3.png"
            msg = "당신은 때론 스스로가 우유부단하다고 느끼거나 혹은 타인으로 부터 그런 말을 듣게 되는 등 당신은 복잡함을 느낄 수 있습니다."
            msg2 = "에너지 흐름이 세 부분으로 나뉘어 흐르고 있기 때문에 무언가를 진행하거나 결정을 내려야 할 때, 그 각각의 다른 묶음들이 각기 다른 주장을 하기 때문입니다. 혼자서 뭔가를 할 때에는 내적 혼란과 갈등을 겪게 됩니다."
            ...
            msg5 = "이 에너지 흐름을 가진 사람들은 인류의 11% 분포에 해당됩니다."
            tag = "갈대같은 사람,한 곳에서 집중이 힘듦,자리를 바꿔 공부할 것"
        elif h_definition == 'definition-4':
            h_type = "네 묶음 흐름"
            img = "https://asset.i-manual.co.kr/static/images/profile/definition/definition_4.png"
            msg = "당신은 우유부단 할 때도 있고 혹은 매우 조급할 때도 있으며 스스로 엄청나게 복잡함을 느낍니다."
            msg2 = "에너지가 네 부분으로 나뉘어 흐르고 있고, 이 각각의 에너지들이 무언가를 하거나 결정을 내려야 할 때, 서로 다른 주장을 하기 때문입니다."
        ...
        if h_type is not None:
            ...
            dispatcher.utter_message('찾고자 하는 에너지 흐름을 저희가 찾지 못했어요. 다시 한번 확인하시어 입력해주세요')
            dispatcher.utter_message(json_message = {
                "type": "tag", 'sender':metadata['uID'], "content": f'절전 모드,한 묶음 흐름,두 묶음 흐름,세 묶음 흐름,네 묶음 흐름', "guide": f'검색 가능한 에너지 흐름을 태그로 보여드릴게요.'})     

        buttons = []
        buttons.append({"title": f'네. 이어서 나의 결정방식에 대해 알아볼래요', "payload": "/leading_authority"})
        buttons.append({"title": f'다른 에너지 흐름도 알아보고 싶어요', "payload": "/definition_common_mean"})
        buttons.append({"title": f'이 항목 말고 다른 설명을 듣고 싶어요', "payload": "/leading_more"})
...
class ActionGetHumanDesignCommonDefinition(Action):
    def name(self) -> Text:
        return "action_get_humandesign_common_definition"
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        dispatcher.utter_message(
            "에너지 흐름은 5가지로 분류될 수 있습니다. 모든 에너지 흐름의 연결은 소중하며, 당신의 삶을 존중함으로써 관계를 탐색할 수 있습니다. 또한 이것을 통해 당신의 '집중력'과 '관심사'에 대해 알 수 있습니다.")
        ...
        retVal = {
            ...
            "payload": {
                ...
                "elements": [
                    {
                        "title": "절전모드",
                        "subtitle": "카멜레온,무한한 잠재성,틈틈이 휴식할 것",
                        "image_url": "https://asset.i-manual.co.kr/static/images/profile/definition/definition_0.png",
                        "buttons": [
                            {
                                "title": "자세히",
                                "type": "postback",
                    ...
                    {
                        "title": "한 묶음 흐름",
                        "subtitle": "혼자서도 잘해요,조용하면 집중력 UP,홀로 공부할 것",
                        "image_url": "https://asset.i-manual.co.kr/static/images/profile/definition/definition_1.png",
                        "buttons": [
                            {
                                "title": "자세히",
                                "type": "postback",
                                "payload": "한 묶음 흐름이란 무엇인가요?"
                            }
                        ]
                    },
                    {
                        "title": "두 묶음 흐름",
                        "subtitle": "카페에서도 공부 잘함,사람에 관심이 많아요,사람 많으면 아이디어 UP",
                        "image_url": "https://asset.i-manual.co.kr/static/images/profile/definition/definition_2.png",
                        "buttons": [
                            {
                                "title": "자세히",
                                "type": "postback",
                                "payload": "두 묶음 흐름이란 무엇인가요?"
                            }
                        ]
                    },
                    {
                        "title": "세 묶음 흐름",
                        "subtitle": "갈대같은 사람,한 곳에서 집중이 힘듦,자리를 바꿔 공부할 것",
                        "image_url": "https://asset.i-manual.co.kr/static/images/profile/definition/definition_3.png",
                        "buttons": [
                            {
                                "title": "자세히",
                                "type": "postback",
                                "payload": "세 묶음 흐름이란 무엇인가요?"
                            }
                        ]
                    },
                    {
                        "title": "네 묶음 흐름",
                        "subtitle": "우유부단,새로운게 필요해,친구들과 공부할 것",
                        "image_url": "https://asset.i-manual.co.kr/static/images/profile/definition/definition_4.png",
                        "buttons": [
                            {
                                "title": "자세히",
                                "type": "postback",
                                "payload": "네 묶음 흐름이란 무엇인가요?"
                            }
                        ]
                    },
                ]
        ...
        dispatcher.utter_message(
            text="각 에너지흐름에 대해 궁금하시면 아래 자세히 버튼을 눌러보세요", attachment=retVal)
        ...
        buttons = []
        buttons.append({"title": f'결정방식 알아보기', "payload": "/leading_authority"})
        buttons.append({"title": f'이 항목 말고 다른 설명을 듣고 싶어요', "payload": "/leading_more"})

        dispatcher.utter_message(
             f'이어서 나의 결정방식을 알아보실래요?', buttons=buttons)
