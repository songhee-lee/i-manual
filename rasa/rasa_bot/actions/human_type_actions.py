...
class ActionLeadingTypeIntro(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if metadata["t"] == 0:
            ...
            msg_1 = "당신은 자신도 모르게 다른 사람들에게 차가운 에너지를 발신하는데, 그 이유는 자신이 하고 싶은 일에만 집중하고 다른 사람들에 대해서는 큰 관심이 없기 때문입니다. 이러한 부류의 사람들을 혁신주도가 종족 또는 메니페스터(Menifester) 종족이라고 부릅니다. 옛날에 태어났다면 왕이나 제사장을 했을 종족입니다."
            msg_2 = '혁신을 주도하고 새로운 일들이 시작될 수 있도록 현시하는 것에 집중합니다. 즉, 당신이 원하는 것을 즉시 표현하고 드러내고 실행하고 실체화 시킬 수 있는 에너지를 가졌다는 것입니다. 다만, 어떻게 하면 사람들과 더 조화롭게 지낼 수 있을지에 대해서는 약간 어려움을 느낄 수도 있고, 자주 크고 작은 마찰을 겪었을지도 모르겠네요.'
            msg_3 = ""
        elif metadata["t"] == 3:
            h_type = "가이드 종족"
            ...
            msg_1 = "당신은 이제까지 살아오면서 특이하다는 말도 많이 들었을 테고, 하고 싶은 게 도대체 뭐니? 라는 말도 정말 많이 들었을 거예요. 당신은 거울과 같은 존재입니다. 다른 사람들의 에너지를 반사하는 능력을 갖고 있습니다. 그래서 당신과 같은 사람들을 거울 종족, 또는 리플렉터(Reflector) 종족이라고 부릅니다."
...
class ActionLeadingType(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if metadata["t"] == 2:
            ...
            msg_3 = '독립심이 강한 혁신주도가에게는 매번 이렇게 자신이 하는 일을 알리는 것 자체로도 너무나 번거롭고 귀찮은 도전일 수 있지만, 그를 통해 사람들은 당신의 행동에 충격을 받거나, 압도되거나, 불편함을 느끼지 않고 평화와 조화를 이룰 수 있습니다.'
        elif metadata["t"] == 3:
            h_type = "가이드 종족"
            msg_1 = "가이드 종족인 여러분에게 가장 중요한 것은 다른 사람으로부터 인정받고 초대받는 것입니다. 심지어는 초대가 오더라도 한 두 번 거절하면서 심사숙고하여 결정해야합니다. 한번 초대를 받아들이면 그 일에 에너지가 묶여 스스로 쉽게 빠져나오지 못하거나, 더 좋은 기회가 오더라도 놓치게 될 수 있습니다. 너무 장기적인 일, 평생을 바쳐야 하는 그런 일보다는 짧은 기간을 주기로 서로 계약을 갱신하거나 주기적으로 서로의 입장을 나눠볼 수 있는 비교적 자유로운 프로젝트 팀에 소속되는 것이 더 편안하고 자신에게 유리할 수 있습니다."
            msg_2 = '가이드 종족은 자기자신의 모습이 아닌 삶을 살 경우 씁쓸함을 맛보게 됩니다. 그와 반대로 자신의 모습 그대로의 삶을 살 경우에는 성공가도를 달리게 되죠. 다른 이들이 가진 잠재력과 독창성을 알아보며 그들을 성공으로 안내하는 것이 바로 가이드 종족의 성공입니다. 가이드 종족의 꿰뚫는 안목으로 다른이들에게 유레카!를 안겨주는 질문을 하든지 그들이 미처 모르고 지나친 부분에 대해 깨달음을 얻을 수 있게 돕습니다.'
            msg_3 = ""
        elif metadata["t"] == 4:
            h_type = "거울 종족"
