...
class ActionLeadingProfileIntro(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if metadata["p"] == 13:
            ...
            msg = "모든 사람은 사회적 성향으로 두개의 숫자를 갖습니다. 당신은 2번과 5번을 갖고 있어 2/5로 표현합니다. 앞의 숫자는 의식, 뒤의 숫자는 무의식의 성향입니다. 2번은 은둔자, 5번은 해결사입니다. 나서기 보다는 은둔하기를 원하지만 무의식에서는 나서서 해결하기를 원한다는 것입니다."
            msg2 = "세상이 어떻게 되는지, 사람들이 어떻게 사는지, 다른 것에는 관심 없고 그냥 자신의 할 일을 하는 은둔자 성향이 강하지만 자신도 모르게 다른 사람들을 끌어당기는 매력이 있고 무슨 일이든 해결해줄 듯한 기대감을 주는 해결사 성향이 함께 섞여 있습니다."
            ...
            msg = "모든 사람은 사회적 성향으로 두개의 숫자를 갖습니다. 당신은 4번과 1번을 갖고 있어 4/1로 표현합니다. 앞의 숫자는 의식, 뒤의 숫자는 무의식의 성향입니다. 4번은 사교가, 1번은 연구자로, 사교가는 사교가인데 연구하는 사교가에요. 4번 사교가 성향은 기본적으로 사람들에게 친절하고, 마음이 열려 있는 편이고, 1번 연구자 성향은 기본적으로 좀 불안해하며, 그 불안감을 해소하기 위해서 자신의 토대, 기반을 갈고 닦고자 연구에 몰두하는 편이에요."
            msg2 = "즉, 의식적으로는 사교적이지만 당신의 무의식은 완벽한 상태인가를 계속 점검하게 만들기 때문에 불안감이 깔려 있게 됩니다. 두가지 성향이 만나, 자신의 토대를 늘 갈고 닦으며 단단히 하는 동시에 사람들과 교류하며 관계도 키워 나가는 모습이에요."
            ...
            img = "https://asset.i-manual.co.kr/static/images/profile/profiles/62.gif"
            msg = "당신은 인류의 3%에 해당하는 특별한 사람입니다. 모든 사람은 사회적 성향으로 두개의 숫자를 갖습니다. 당신은 6번과 3번을 갖고 있어 6/3으로 표현합니다. 앞의 숫자는 의식, 뒤의 숫자는 무의식의 성향입니다. 6번은 관조자 3번은 도전가로, 의식적으로는 관조자이지만, 무의식에서는 끊임없이 도전하게 만드는 성향을 가진 사람입니다. "
            msg2 = "삶에서 완벽한 것은 무엇일까? 라는 질문의 답을 찾는 성향의   사람입니다. 왜냐하면 당신의 삶은 잠재적으로 혼란과 불안정함을 늘 가지고 있을 수 있거든요. 오뚝이처럼 넘어지고 넘어져도 다시 일어나서 또 도전하는 시행착오 그 자체의 삶입니다. 이것은 무척 어렵고 고달플 수도 있지만, 그 시간이 지나고 나면 그동안의 고난을 보상해주듯 누구도 얻지 못하는 귀한 지혜를 깨닫게 될 거에요."
...
class ActionLeadingProfile(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if metadata["p"] == 13:
            ...
            h_type = "은둔자/은근 해결사 (2/5)"
            msg4 = "사람들이 모여 있는 방에 당신이 문을 열고 들어가는 순간, 이미 그 방에 있는 모두로부터 기대와 관심을 끌게 됩니다. 저 사람이 날 구원해줄거야 하는 기대를 받게 되는 거죠. 여러 사람들의 투사 중에서 무엇이 내가 만족시켜줄 수 있는 것인지, 확실하게 판단하지 못한다면 불구덩이에 스스로 들어가는 셈이에요."
            msg5 = "안타깝지만 다른 사람들의 기대와 투사를 피할 수는 없습니다. 당신의 존재 자체가 그들을 매혹하니까요. 다만 그 기대들 중에서 무엇이 내가 해결 가능한 것인지 분별할 수 있어야 합니다."
            tag = "기대를 한몸에 ,혼자가 편해요 ,츤데레 컨셉 유지할 것"
        elif metadata["p"] == 35:
            h_type = "도전가/은근 해결사 (3/5)"
            msg4 = "해결사의 역할을 할 수 있는 이유는 다른 사람들이 당신에게 갖는 ‘해결사의 역할을 해줄 것이라는 기대감’ 때문입니다. 기대감은 사실과 다를 수 있지만 다른 사람들이 당신에게 갖는 환상이 그렇습니다."
            ...
            h_type = "사교가/은근 연구자 (4/1)"
            msg4 = "삶에서 당신을 매혹하는 뭔가를 찾으면 그것에 완전히 빠져드는 편이에요. 그 분야를 파고들어 기초를 닦아 토대를 이루면 당신이 쌓은 지식을 통해 사람들에게 전하고 영향력을 발휘합니다. 당신이 어떤   분야의 전문가가 된다면 1번 연구자 성향에서 오는 불안감은 사라지고 당신의 힘이 되어주는 권위과 명예만 남습니다."
            msg5 = "그 힘을 가지고 4번 사교가의 힘을 발휘해 사람들과 교류하고 당신의 지혜를 전달하게 되죠. 4번 사교가 성향 덕에 당신은 이미 어떻게 하면 가장 적절하게 의사소통을 나누며 교류하는지 알고 있습니다."
            tag = "안정감 추구 ,끝없는 연구,고집은 잠시 내려놓을 것"
        elif metadata["p"] == 46:
            h_type = "사교가/은근 관조자 (4/6)"
            msg4 = "첫 번째 시기를 거쳐 약 30세~50세 전후의 두 번째 시기는 삶이 조금은 편안해지고 안정적으로 흘러가기 때문에 여유가 생깁니다."
            ...
            h_type = "관조자/은근 도전가 (6/3)"
            msg4 = "당신은 끈기와 회복력을 타고났어요. ‘신은 견딜 수 있을 만큼의 시련을 준다’ 라는 말이 어쩌면 당신에게 딱 맞는 말일수도 있어요. 당신이 견딜 수 있는 만큼의 혼란과 놀라움을 겪게 될 것입니다. 그 모든 경험들을 지나고 나면 이 세상을 사는데 꼭 필요한 지혜를 많은 사람들에게 전하게 됩니다."
            msg5 = "각자가 지닌 자신만의 개성을 꽃피우고 진정한 자기 자신의 모습으로 깨어나도록 돕게 됩니다."
            tag = "몸으로 부딪히기 ,경험으로 인한 성장,주변에 소홀하지 말 것"
