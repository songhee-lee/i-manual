    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if is_finished == 1:
            dispatcher.utter_message(json_message={
                ...
                "content": "{0}/{1}/{2}.mp3".format(lang, ninei, int(type_description[voice_num][0])),
        ...
        if (metadata["t"] == 0):
            ...
            dispatcher.utter_message(json_message={
                "type": "voiceID", "sender": metadata['uID'], 
                "content": "{0}/{1}/{2}.mp3".format(lang, ninei, int(type_description[voice_num][1])),
            ...
            dispatcher.utter_message(json_message={
                "type": "voiceID", "sender": metadata['uID'], 
                "content": "{0}/{1}/{2}.mp3".format(lang, ninei, int(type_description[voice_num][2])),
            ...
            dispatcher.utter_message(json_message={
                "type": "voiceID", "sender": metadata['uID'], 
                "content": "{0}/{1}/{2}.mp3".format(lang, ninei, int(type_description[voice_num][3])),
            ...
            dispatcher.utter_message(json_message={
                "type": "voiceID", "sender": metadata['uID'], 
                "content": "{0}/{1}/{2}.mp3".format(lang, ninei, int(type_description[voice_num][4])),
            ...
            dispatcher.utter_message(json_message={
                "type": "voiceID", "sender": metadata['uID'], 
                "content": "{0}/{1}/{2}.mp3".format(lang, ninei, int(type_description[voice_num][5])),
