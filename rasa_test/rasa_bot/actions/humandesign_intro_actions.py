...
class ActionSetPriority(Action):  # 맨 처음
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        #        "type": "voiceID", 'sender': metadata['uID'], "content": "out_5/10101.mp3", "data" : 
        #    }
        #)
            ...
            if leading_priority[step - 1] == 3 and center_step < 9: # 우선순위가 센터(3)이고 센터 리딩이 끝나지 않은 경우
                ...
                if step == 4:   #모든 리딩이 끝난 경우
                    ...
                    dispatcher.utter_message(json_message={
                        ...
                        "content": "{0}/{1}/{2}.mp3".format(lang, ninei, int(etc_description[voice_num][3])),
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if center_step == 0 or center_step == 9:
            if step == 4 and is_finished == 0:
                ...
                dispatcher.utter_message(json_message={
                    "type": "voiceID", "sender": metadata['uID'], 
                    "content": "{0}/{1}/{2}.mp3".format(lang, ninei, int(etc_description[voice_num][1])),
