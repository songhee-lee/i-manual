...
def get_TTS(string, metadata):
    members= ['', '4_minjun', '5_bahn', '6_berry', '7_seowon', '3_winnie', '2_eden', '1_jaewon', '9_juhyung', '10_jiho', '8_taehun' ]
...
def unego_get_question(ct, unego_count, lang, defined=False):
    ...
    if ct == 0 and not defined:
        ...
        vlist = [
            unego_description[voice_num][0],
            unego_description[voice_num][1],
            unego_description[voice_num][2]
        ]
        unego_voice = unego_description[voice_num][102]
        unego_comment_voice = unego_description[voice_num][4]
        ego_comment_voice = unego_description[voice_num][3]
        ...
        vlist = [
            unego_description[voice_num][5],
            unego_description[voice_num][6],
            unego_description[voice_num][7]
        ]
        unego_voice = unego_description[voice_num][102]
        unego_comment_voice = unego_description[voice_num][9]
        ego_comment_voice = unego_description[voice_num][8]
    # 활력센터
        ...
        vlist = [
            unego_description[voice_num][10],
            unego_description[voice_num][11],
            unego_description[voice_num][12]
        ]
        unego_voice = unego_description[voice_num][103]
        unego_comment_voice = unego_description[voice_num][14]
        ego_comment_voice = unego_description[voice_num][13]
        ...
        vlist = [
            unego_description[voice_num][15],
            unego_description[voice_num][16],
            unego_description[voice_num][17]
        ]
        unego_voice = unego_description[voice_num][103]
        unego_comment_voice = unego_description[voice_num][19]
        ego_comment_voice = unego_description[voice_num][18]
    # 직관센터
        ...
        vlist = [
            unego_description[voice_num][20],
            unego_description[voice_num][21],
            unego_description[voice_num][22]
        ]
        unego_voice = unego_description[voice_num][104]
        unego_comment_voice = unego_description[voice_num][24]
        ego_comment_voice = unego_description[voice_num][23]
        ...
        vlist = [
            unego_description[voice_num][25],
            unego_description[voice_num][26],
            unego_description[voice_num][27]
        ]
        unego_voice = unego_description[voice_num][104]
        unego_comment_voice = unego_description[voice_num][29]
        ego_comment_voice = unego_description[voice_num][28]
    # 감정센터
        ...
        vlist = [
            unego_description[voice_num][30],
            unego_description[voice_num][31],
            unego_description[voice_num][32]
        ]
        unego_voice = unego_description[voice_num][105]
        unego_comment_voice = unego_description[voice_num][34]
        ego_comment_voice = unego_description[voice_num][33]
        ...
        vlist = [
            unego_description[voice_num][35],
            unego_description[voice_num][36],
            unego_description[voice_num][37]
        ]
        unego_voice = unego_description[voice_num][105]
        unego_comment_voice = unego_description[voice_num][39]
        ego_comment_voice = unego_description[voice_num][38]
    # 에고센터
        ...
        vlist = [
            unego_description[voice_num][40],
            unego_description[voice_num][41],
            unego_description[voice_num][42]
        ]
        unego_voice = unego_description[voice_num][106]
        unego_comment_voice = unego_description[voice_num][44]
        ego_comment_voice = unego_description[voice_num][43]
        ...
        vlist = [
            unego_description[voice_num][45],
            unego_description[voice_num][46],
            unego_description[voice_num][47]
        ]
        unego_voice = unego_description[voice_num][106]
        unego_comment_voice = unego_description[voice_num][49]
        ego_comment_voice = unego_description[voice_num][48]
    # 방향센터
        ...
        vlist = [
            unego_description[voice_num][50],
            unego_description[voice_num][51],
            unego_description[voice_num][52]
        ]
        unego_voice = unego_description[voice_num][107]
        unego_comment_voice = unego_description[voice_num][54]
        ego_comment_voice = unego_description[voice_num][53]
        ...
        vlist = [
            unego_description[voice_num][55],
            unego_description[voice_num][56],
            unego_description[voice_num][57]
        ]
        unego_voice = unego_description[voice_num][107]
        unego_comment_voice = unego_description[voice_num][59]
        ego_comment_voice = unego_description[voice_num][58]
    # 표현센터
        ...
        vlist = [
            unego_description[voice_num][60],
            unego_description[voice_num][61],
            unego_description[voice_num][62]
        ]
        unego_voice = unego_description[voice_num][108]
        unego_comment_voice = unego_description[voice_num][64]
        ego_comment_voice = unego_description[voice_num][63]
        ...
        vlist = [
            unego_description[voice_num][65],
            unego_description[voice_num][66],
            unego_description[voice_num][67]
        ]
        unego_voice = unego_description[voice_num][108]
        unego_comment_voice = unego_description[voice_num][69]
        ego_comment_voice = unego_description[voice_num][68]
    # 생각센터
        ...
        vlist = [
            unego_description[voice_num][70],
            unego_description[voice_num][71],
            unego_description[voice_num][72]
        ]
        unego_voice = unego_description[voice_num][109]
        unego_comment_voice = unego_description[voice_num][74]
        ego_comment_voice = unego_description[voice_num][73]
        ...
        vlist = [
            unego_description[voice_num][75],
            unego_description[voice_num][76],
            unego_description[voice_num][77]
        ]
        unego_voice = unego_description[voice_num][109]
        unego_comment_voice = unego_description[voice_num][79]
        ego_comment_voice = unego_description[voice_num][78]
    # 영감센터
        ...
        vlist = [
            unego_description[voice_num][80],
            unego_description[voice_num][81],
            unego_description[voice_num][82]
        ]
        unego_voice = unego_description[voice_num][110]
        unego_comment_voice = unego_description[voice_num][84]
        ego_comment_voice = unego_description[voice_num][83]
        ...
        vlist = [
            unego_description[voice_num][85],
            unego_description[voice_num][86],
            unego_description[voice_num][87]
        ]
        unego_voice = unego_description[voice_num][110]
        unego_comment_voice = unego_description[voice_num][89]
        ego_comment_voice = unego_description[voice_num][88]
