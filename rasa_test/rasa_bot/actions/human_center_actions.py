...
for i in range(0, 137):
    description.append(center_description_csv.iloc[i,1])
...
class ActionLeadingCentersIntro(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if h_center == 0 and metadata['ct'][0] == 1:
            ...
            msg = description[101]
            msg2 = description[102]
            msg3 = description[103]
            msg4 = description[104]
            ...
            msg = description[110]
            msg2 = description[111]
            msg3 = description[112]
            ...
            msg = description[119]
            msg2 = description[120]
            msg3 = description[121]
            ...
            msg = description[131]
            msg2 = description[132]
            msg3 = description[133]
...
class ActionLeadingCenters(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if h_center == 0 and metadata['ct'][0] == 1:
            ...
            img = "https://asset.i-manual.co.kr/static/images/centerCard/card_3_off.png"
            msg = description[106]
            msg2 = description[107]
            msg3 = description[108]
            msg4 = description[109]
        elif h_center == 4 and metadata['ct'][4] == 0:
            h_type = "에고 센터 ( 미정의 )"
            center_name = "에고센터"
            img = "https://asset.i-manual.co.kr/static/images/centerCard/card_4_off.png"
            msg = description[114]
            msg2 = description[115]
            msg3 = description[116]
            msg4 = description[117]
            msg5 = description[118]
        elif h_center == 5 and metadata['ct'][5] == 0:
            h_type = "방향 센터 ( 미정의 )"
            center_name = "방향센터"
            img = "https://asset.i-manual.co.kr/static/images/centerCard/card_5_off.png"
            msg = description[123]
            msg2 = description[124]
            msg3 = description[125]
        elif h_center == 6 and metadata['ct'][6] == 0:
            h_type = "표현 센터 ( 미정의 )"
            center_name = "표현센터"
            img = "https://asset.i-manual.co.kr/static/images/centerCard/card_6_off.png"
            msg = description[129]
            msg2 = description[130]
...
class ActionCenterDetailIntro(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if h_center == 0 and metadata['ct'][0] == 1:
            h_type = "연료 센터 ( 정의 )"
            dispatcher.utter_message(description[26], buttons=buttons)
        elif h_center == 2 and metadata['ct'][2] == 1:
            h_type = "직관 센터 ( 정의 )"
            dispatcher.utter_message(description[35], buttons=buttons)

        elif h_center == 3 and metadata['ct'][3] == 1:
            h_type = "감정 센터 ( 정의 )"
            dispatcher.utter_message(description[44], buttons=buttons)

        elif h_center == 4 and metadata['ct'][4] == 1:
            h_type = "에고 센터 ( 정의 )"
            dispatcher.utter_message(description[51], buttons=buttons)
        elif h_center == 5 and metadata['ct'][5] == 1:
            h_type = "방향 센터 ( 정의 )"
            dispatcher.utter_message(description[60], buttons=buttons)
        elif h_center == 6 and metadata['ct'][6] == 1:
            h_type = "표현 센터 ( 정의 )"
            dispatcher.utter_message(description[70], buttons=buttons)



        elif h_center == 0 and metadata['ct'][0] == 0:
            h_type = "연료 센터 ( 미정의 )"
            dispatcher.utter_message(description[84], buttons=buttons)
        elif h_center == 2 and metadata['ct'][2] == 0:
            h_type = "직관 센터 ( 미정의 )"
            dispatcher.utter_message(description[97], buttons=buttons)
        elif h_center == 3 and metadata['ct'][3] == 0:
            h_type = "감정 센터 ( 미정의 )"
            dispatcher.utter_message(description[105], buttons=buttons)
        elif h_center == 4 and metadata['ct'][4] == 0:
            h_type = "에고 센터 ( 미정의 )"
            dispatcher.utter_message(description[113], buttons=buttons)
        elif h_center == 5 and metadata['ct'][5] == 0:
            h_type = "방향 센터 ( 미정의 )"
            dispatcher.utter_message(description[122], buttons=buttons)
        elif h_center == 6 and metadata['ct'][6] == 0:
            h_type = "표현 센터 ( 미정의 )"
            dispatcher.utter_message(description[128], buttons=buttons)
